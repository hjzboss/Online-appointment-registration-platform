  ...
  <div class="nav-container page-component">
    ...
    <div class="nav left-nav">
      ...
      <div class="nav-item selected">
        <span class="v-link selected dark" onclick="window.location='/patient'"> 就诊人管理 </span>
      </div>
      <div class="nav-item ">
          ...
          <div class="content-wrapper">
            <el-form :model="patient" label-width="110px" label-position="left" ref="patient" :rules="validateRules">
              ...
              <el-form-item prop="address" label="详细地址：">
                <el-input v-model="patient.address" placeholder="请填写现真实住址" class="input v-input"/>
              </el-form-item>
            </el-form>
          </div>
          <div class="sub-title">
...
export default {
  ...
  mounted() {
    if (this.$route.query.id) {
      setTimeout(() => {
        this.$refs.selectedShow.presentText = this.patient.param.provinceString + '/' + this.patient.param.cityString + '/' + this.patient.param.districtString //"北京市/市辖区/西城区";
      }, 1000)
    }
  },
  methods: {
