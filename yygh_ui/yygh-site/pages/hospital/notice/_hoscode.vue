    ...
    <div class="page-container">
      <div class="hospital-notice">
        <div class="content">
          ...
          <p>
            已完成预约的号源，如需办理退号，至少在就诊前一工作日14:00前通过网站、微信公众号等平台预约渠道进行取消预约。
          </p>
          ...
          <ul>
            <li>
              累计爽约3次，自3次爽约日起，90天内不允许通过陕医通平台进行预约挂号；
            </li>
            <li>
              累计爽约6次，自6次爽约日起，180天内不允许通过陕医通平台进行预约挂号。
            </li>
          </ul>
        </div>
      </div>
